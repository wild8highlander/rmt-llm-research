...
class Parameter:
    ...
    def __post_init__(self) -> None:
        ...
        if isinstance(self.step, str):
            self.step = (
                INF if self.step.lower() in ("inf", "+inf", "infinity") else float(self.step)
            )
...
def default_parameter_space() -> list[Parameter]:
    ...
    return [
        ...
        Parameter(
            "n_layers", "int", 6, 1, INF, 1, unit="", description="Number of transformer layers"
        ),
        Parameter(
            "hidden_dim",
            "int",
        ...
        Parameter("n_heads", "int", 4, 1, INF, 1, unit="", description="Number of attention heads"),
        Parameter(
            "vocab_size",
            "int",
            256,
        ...
        Parameter("seed", "int", 42, 0, INF, 1, unit="", description="Random seed"),
        Parameter(
            "epochs",
            "int",
            3,
        ...
        Parameter(
            "learning_rate", "float", 1e-3, 0.0, INF, 1e-6, unit="", description="Learning rate"
        ),
        Parameter("batch_size", "int", 4, 1, INF, 1, unit="", description="Batch size"),
        ...
        Parameter(
            "language", "categorical", "en", choices=["en", "ru"], description="Output language"
        ),
        Parameter(
            "report_format",
            "categorical",
